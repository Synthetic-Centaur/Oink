...
export function homePageReducer(state = {
  ...
  switch (action.type) {
    ...
    case 'RESET_STATE':
      return Object.assign({}, state, {numberError: true, categoryError: true, showSettings: false, showVerify: false, verifySuccess: true, firstPull: false, errorText: '', category: ''})
    default:
      return state
  }
}
